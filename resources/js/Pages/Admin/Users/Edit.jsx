        ...
        <AdminLayout>
            <div className="max-w-2xl mx-auto py-6">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-3xl font-bold text-[#E2FAF7]">Edit User</h1>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="bg-[#0E2C28] border border-[#1d6361] rounded p-4">
                            <p className="text-sm text-[#7ABFB9]">
                                <strong>Note:</strong> To change user password, the user can use the "Forgot Password" option on the login page.
                            </p>
                        </div>
