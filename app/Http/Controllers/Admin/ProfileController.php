...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        AuditLog::log('updated', 'admin_profile', 'Updated own account settings');
    ...
    public function updatePassword(Request $request)
    {
        ...
        AuditLog::log('updated', 'admin_password', 'Updated own password');
    ...
    public function updatePreferences(Request $request)
    {
        ...
        AuditLog::log('updated', 'admin_preferences', 'Updated own preferences');
